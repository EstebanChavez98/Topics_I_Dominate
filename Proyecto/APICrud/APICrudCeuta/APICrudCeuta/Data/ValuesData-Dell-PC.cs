...
namespace APICrudCeuta.Data
{
    public class ValuesData
    {
        ...
        public string GuardarDatosPersona(string _nombre, string _depto, string _persona, string _ip)
        {
            ...
            if (!(string.IsNullOrWhiteSpace(_nombre) || string.IsNullOrWhiteSpace(_depto) || string.IsNullOrWhiteSpace(_persona) || string.IsNullOrWhiteSpace(_ip)))
            {
        ...
        public string ModificarIP(string _nombre, string _ip)
        {
            ...
            if (!(string.IsNullOrWhiteSpace(_nombre) || string.IsNullOrWhiteSpace(_ip)))
            {
                ...
                if (match.Success)
                {
                    ...
                    respuestaBD = lector = cmd.ExecuteReader() == -1 ? "No se encontro ningun dato" : "Modificacion exitosa en la Base de datos";
