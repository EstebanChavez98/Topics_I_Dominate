...
namespace APICrudCeuta.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        // GET api/values
        [HttpGet("{visita.Nombre}&{visita.Departamento}&{visita.Persona}&{visita.IP}&")]
        public string GuardarDatos([FromRoute] VisitasModel visita)
        {
            return data.GuardarDatosPersona(visita.Nombre, visita.Departamento, visita.Persona, visita.IP);
        }
